...
var create = module.exports = function(options){
	...
	server.adapterMapping = options.adapterMapping || [];
...
HttpServer.prototype.getResource = function(request, response){
	...
	fs.exists(filePath, function(exists){
		if(exists){
            ...
            if (~filePath.indexOf(self.adapterMapping[0])) {
                serveAdaptedMappingFile(request, response, filePath, self.adapterMapping[1]);
